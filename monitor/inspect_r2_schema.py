...
_FILES_OPTIONAL_SCRAPERS = frozenset({
    "Cars_for_sale_rent (Cars)",
    "Parts & Accessories (Cars)",
    "Trucks and heavy equipment (Cars)",
    "Motorcycles (Cars)",
    "Phones (Devices)",
    "Computers (Devices)",
    "Home & Kitchen Appliances (Devices)",
    "Accounts and Subscriptions (Devices)",
    "TV & Audio (Devices)",
    "Digital Cameras (Devices)",
    "Special Numbers (Devices)",
    "Generators (Devices)",
    "Gaming (Devices)",
    "Microsoft (Devices)",
    "LG (Devices)",
    ...
    "Hitachi (Devices)",
    "Tablets (Devices)",
    "Uncategorized Devices (Devices)",
    "Apartments for Rent (Real_Estate)",
    "Lands For Sale (Real_Estate)",
    "Chalets for rent (Real_Estate)",
    "Villas for sale (Real_Estate)",
    "Apartments for sale (Real_Estate)",
    "Shops for waiver (Real_Estate)",
    "Rooms for rent (Real_Estate)",
    "Building for sale (Real_Estate)",
    "Floor Through For Sale (Real_Estate)",
    "Shops for rent (Real_Estate)",
    "Villas for rent (Real_Estate)",
    "Floors Through for rent (Real_Estate)",
    "Warehouses for rent (Real_Estate)",
    "Houses for sale (Real_Estate)",
    "Farms for sale (Real_Estate)",
    "Offices For Rent (Real_Estate)",
    "Buildings for rent (Real_Estate)",
    "RestHouse for sale (Real_Estate)",
    "Commercial Land For Sale (Real_Estate)",
    "Farm for rent (Real_Estate)",
    "Houses for rent (Real_Estate)",
    "Chalets for sale (Real_Estate)",
    "Warehouse for sale (Real_Estate)",
    "Camps for rent (Real_Estate)",
    "Compound for sale (Real_Estate)",
    "Compound for rent (Real_Estate)",
    "Hall for rent (Real_Estate)",
    "Houseware (Furniture)",
    "Sofas and furnishings (Furniture)",
    "tables and chairs (Furniture)",
    "Beds and mattresses (Furniture)",
    "Cabinets and cupboards (Furniture)",
    "Outdoor furniture (Furniture)",
    "Antiques and decor (Furniture)",
    "Office Furniture (Furniture)",
    "Construction Services (Services)",
    "Delivery Services (Services)",
    "Agent Services (Services)",
    "Furniture Transfering Services (Services)",
    "Cleaning Services (Services)",
    "legal services (Services)",
    "Accounting and financial services (Services)",
    "Buying From Foregin Websites Services (Services)",
    "Other services (Services)",
    "Women's fashion (Fashion)",
    "Sports Accessories (Fashion)",
    "Man Clothes (Fashion)",
    "Perfumes and Incense (Fashion)",
    "Watches (Fashion)",
    ...
    "Hamsters (Animals)",
    "Squirrels (Animals)",
    "Administrative functions (Jobs)",
    "Home employment jobs (Jobs)",
    "Jobs Restaurants (Jobs)",
    "Costumes and beauty jobs (Jobs)",
    "Industrial Jobs (Jobs)",
    "Educational functions (Jobs)",
    "Jobs Medical and Nursing (Jobs)",
    "Building and building jobs (Jobs)",
    "Security and safety jobs (Jobs)",
    "Technical and design functions (Jobs)",
    "Agricultural and grazing functions (Jobs)",
    "Games",
    "Private classes (Coaching)",
    "Training courses (Coaching)",
    "Sports Exercices (Coaching)",
    "Leading (Coaching)",
    "Electronic Games Training (Coaching)",
    "Education shares and currencies (Coaching)",
    "Food",
    "Events",
    "Coding",
    "Gardens",
